...
dependency of framework-specific reporters (currently [`@tiden/playwright-reporter`](../playwright/README.md)).
...
consumer-facing [`playwright/README.md`](../playwright/README.md#configuration) — see that file
